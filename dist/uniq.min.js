...
if(s&&f===f){for(var h=l.length;h--;)if(l[h]===f)continue e;c.push(_)}else i(l,f,void 0)||(l!==c&&l.push(f),c.push(_))}e=c}else e=[];return e},o.eq=h,o.isFunction=p,o.isObject=d,o.noop=y,o.VERSION="4.17.5",typeof define=="function"&&typeof define.amd=="object"&&define.amd?(j._=Object.assign(j._||{},o), define(function(){return o})):m?((m.exports=Object.assign(m.exports||{},o))._=m.exports,O._=o):j._=Object.assign(j._||{},o)}).call(this);